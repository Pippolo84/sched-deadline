...
struct rt_rq {
	...
	u64 enqueue_cycles, dequeue_cycles, set_cycles;
	unsigned long nr_enqueue, nr_dequeue;
	u64 push_cycles, push_find_cycles, pull_cycles;
	unsigned long nr_push, nr_pull;
	unsigned long nr_push_find, nr_set;
#endif
...
struct dl_rq {
	...
	u64 enqueue_cycles, dequeue_cycles, set_cycles_push, set_cycles_pull;
	unsigned long nr_enqueue, nr_dequeue;
	u64 push_cycles, push_find_cycles, pull_cycles, pull_find_cycles;
	unsigned long nr_push, nr_pull;
	unsigned long nr_push_find, nr_set_push, nr_pull_find, nr_set_pull;
#endif
